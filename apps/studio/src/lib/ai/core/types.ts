 ...
 */
export type BackendProvider = "accuralai";

/**
 * AccuralAI (Vercel AI) model identifier with provider prefixes
 */
export type AccuralAIModelId =
...
export const DEFAULT_ACCURALAI_MODEL: AccuralAIModelId = "google:gemini-2.5-flash";
